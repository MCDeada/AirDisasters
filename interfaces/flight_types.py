...
class FlightTypes(Base):
    ...
    def get_rows_all_foreign(self) -> Response:
        ...
        res_dict = {row['id']: row['flight_type'] for row in res['result']}
    ...
    def update(self, data: Dict[str, Any]) -> Response:
        ...
        WHERE id = %s;
        """
        tupled_data = (data['flight_type'], data['row_id'],)
